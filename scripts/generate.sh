#!/bin/sh
# Regenerate src/Cases.mw for pretty.
#
#   scripts/generate.sh
#
# The crate version is pinned in scripts/generate/Cargo.toml. To move to a new
# one, change the pin and run this: if it has changed, the generator stops and
# says so, and src/ has to be brought into line with it before the fingerprint
# in scripts/generate/src/main.rs is moved.
#
